...
//    }
    ...
    fun testOpenTextInNewActivity() {
        ...
        val newActivityText = "text"
        device.wait(Until.hasObject(By.res(packageName, newActivityText)), TIMEOUT)

        val result = device.findObject(By.res(packageName, newActivityText)).text
        assertEquals(result, textToSet)
    }
